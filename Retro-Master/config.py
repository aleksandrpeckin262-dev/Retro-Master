...
# Базовые каталоги 
ICON_PATH = r'D:\Retro-Master\icon.ico'
BASE_DIR = os.getcwd()
...
THEME_RESOURCES = {
    "win95": {
        ...
        "cursors_dir": r"D:\Retro-Master\cursor_now\win95_cur"                                                        # Папка, где лежат курсоры 95
    },
    "win98": {
        ...
        "icon_trash_full": r"D:\Retro-Master\icons_now\icon_win98\trash_full_win98\trash_full_win98.ico",             # иконка полной корзины
        "cursors_dir": r"D:\Retro-Master\cursor_now\win98_cur"                                                        # Папка, где лежат курсоры 98
    },
    "winXP": {
        ...
        "cursors_dir": r"D:\Retro-Master\cursor_now\winXP_cur"                                                        # Папка, где лежат курсоры XP
    },
    "vista": {
        ...
        "cursors_dir": r"D:\Retro-Master\cursor_now\winVista_cur"                                                     # Папка, где лежат курсоры Vista
    },
    "win7": {
        ...
        "cursors_dir": r"D:\Retro-Master\cursor_now\win7_cur"                                                         # Папка, где лежат курсоры 7
    },
    # Пути для отката
    "restore": {
